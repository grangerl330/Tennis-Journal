...
User.create(first_name: "User", last_name: "2", email: "user2@gmail.com", password: "password", utr: 9, match_record: "", ranking: 32)
User.create(first_name: "User", last_name: "3", email: "user3@gmail.com", password: "password", utr: 8, match_record: "", ranking: 56)
