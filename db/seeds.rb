...
#Opponents
Opponent.create(first_name: "Opponent", last_name: "1", age: 15, handedness: "Right", notes: "", strengths: "", weaknesses: "", utr: 9, match_id: 1)
Opponent.create(first_name: "Opponent", last_name: "2", age: 15, handedness: "Left", notes: "", strengths: "", weaknesses: "", utr: 10, match_id: 2)
Opponent.create(first_name: "Opponent", last_name: "3", age: 14, handedness: "Right", notes: "", strengths: "", weaknesses: "", utr: 11, match_id: 3)
Opponent.create(first_name: "Opponent", last_name: "4", age: 14, handedness: "Right", notes: "", strengths: "", weaknesses: "", utr: 9, match_id: 4)
Opponent.create(first_name: "Opponent", last_name: "5", age: 16, handedness: "Left", notes: "", strengths: "", weaknesses: "", utr: 10, match_id: 5)
Opponent.create(first_name: "Opponent", last_name: "6", age: 16, handedness: "Right", notes: "", strengths: "", weaknesses: "", utr: 11, match_id: 6)
